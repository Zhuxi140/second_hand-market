...
public class UserAddressMapperHelper {
    ...
    // 插入地址
    public void insert(UserAdsRegisterDTO userAddress, String userSn) {
    ...
    public void updateAds(UserAdsUpdate update, String addressSn){
    ...
    // 修改地址基础信息
    public void updateBase(UserAdsBaseUpdate update, String addressSn) {
    ...
    // 修改地址位置信息
    public void updateLocation(UserAdsLocationUpdate update, String addressSn) {
