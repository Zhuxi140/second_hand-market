package com.zhuxi.user.module.domain.address.model;

import com.zhuxi.user.module.domain.address.ValueObject.PostalAddress;
import com.zhuxi.user.module.domain.address.ValueObject.Recipient;
