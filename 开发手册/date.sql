...
CREATE TABLE `user` (
  ...
  `userStatus` TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态',
...
CREATE TABLE `user_order` (
  ...
  `userStatus` TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT '订单状态(1待付款 2待发货 3待收货 4已完成 5已取消 6已退款)',
...
CREATE TABLE `product` (
  ...
  `userStatus` TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT '商品状态 (1在售 2已预订 3已售出 4审核中)',
...
CREATE TABLE `admin` (
  ...
  `userStatus` TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态 (1正常 2锁定)',
...
CREATE TABLE `shop` (
  ...
  `userStatus` TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT '商铺状态 (1开店中 2闭店中)',
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
