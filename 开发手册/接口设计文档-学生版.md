...
```http
GET /user/{userSn}/products?page=1&size=20&userStatus=1
Authorization: Bearer <token>
```
...
```http
GET /user/{userSn}/orders?page=1&size=20&userStatus=1&type=buyer
Authorization: Bearer <token>
```
...
```http
GET /admin/users?page=1&size=20&userStatus=1
