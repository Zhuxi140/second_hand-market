...
| userStatus             | tinyint       | 订单状态(1待付款 2待发货 3待收货 4已完成 5已取消 6已退款) |                   |
...
| userStatus      | tinyint       | 商品状态           | 1在售 2已预订(交涉中) 3已售出 4审核中                        |
...
| userStatus      | tinyint      | 商铺状态       | 1开店中 2闭店中   |
| created_at  | datetime     | 创建时间       | CURRENT_TIMESTAMP |
