...
import com.zhuxi.common.shared.exception.safe.PermissionException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({
            BusinessException.class, PersistenceException.class,
            TokenException.class, COSException.class,
